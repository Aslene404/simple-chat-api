using System;
using tp.SimpleChat.DependencyResolver;
using tp.SimpleChat.DataRepositories.Context;
...
using tp.SimpleChat.Core.AppSetting;
using System.Text;
using tp.SimpleChat.Core.Entities;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Microsoft.IdentityModel.Tokens;
using tp.SimpleChat.API.Hubs;
using Microsoft.AspNetCore.Http.Connections;
using Autofac;
using Autofac.Extensions.DependencyInjection;

namespace tp.SimpleChat
{
